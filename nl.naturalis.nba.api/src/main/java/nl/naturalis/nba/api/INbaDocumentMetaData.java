...
public interface INbaDocumentMetaData<DOCUMENT_OBJECT extends IDocumentObject> {
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/&lt;document-type&gt;/metadata/getSetting/{name}
	 * </code>
	 * </p>
	 * 
	 * @return
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/&lt;document-type&gt;/metadata/getSettings
	 * </code>
	 * </p>
	 * <p>
	 * Examples:
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/multimedia/metadata/getSettings<br>
	 * </code>
	 * </p>
	 * 
	 * @return
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/&lt;document-type&gt;/metadata/getPaths
	 * </code>
	 * </p>
	 * <p>
	 * Examples:
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/multimedia/metadata/getPaths<br>
	 * https://api.biodiversitydata.nl/v2/taxon/metadata/getPaths/?sorted=true
	 * </code>
	 * </p>
	 * 
	 * @param sorted
	 ...
	 * 
	 * <pre>
	 * https://api.biodiversitydata.nl/v2/&lt;document-type&gt;/metadata/getFieldInfo
	 * https://api.biodiversitydata.nl/v2/&lt;document-type&gt;/metadata/getFieldInfo/?fields=field0,field1,field2
	 * </pre>
	 * </p>
	 * <p>
	 * Examples:
	 ...
	 * https://api.biodiversitydata.nl/v2/specimen/metadata/getFieldInfo/?fields=unitID,gatheringEvent.dateTimeBegin
	 * </pre>
	 * </p>
	 * 
	 * @param fields
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/&lt;document-type&gt;/isOperatorAllowed/{field}/{operator}
	 * </code>
	 * </p>
	 * <p>
	 * For example:
	 ...
	 * <p>
	 * <code>
	 * https://api.biodiversitydata.nl/v2/specimen/isOperatorAllowed/unitID/BETWEEN
	 * </code>
	 * </p>
	 * 
	 * @param field
