...
/**
 * Specifies methods for accessing {@link ScientificNameGroup_old} documents.
 * 
 * @see ScientificNameGroup_old
 * @see ScientificName#getScientificNameGroup()
 * 
 * @author Ayco Holleman
 *
 */
public interface IScientificNameGroupAccess extends INbaAccess<ScientificNameGroup_old> {

	/**
	 * <p>
	 * Returns {@link ScientificNameGroup_old} documents conforming to the provided
	 ...
	 * {@link GroupByScientificNameQuerySpec}.
	 * </p>
	 * <h5>REST API</h5>
	 * <p>
	 ...
	 */
	QueryResult<ScientificNameGroup_old> query(QuerySpec querySpec) throws InvalidQueryException;
	 ...
	 * {@link GroupByScientificNameQuerySpec}. The extra query specification
	 ...
	 * the {@link GroupByScientificNameQuerySpec QuerySpec} object is structured.
	 ...
	 * direct child of the {@link GroupByScientificNameQuerySpec QuerySpec}
	 ...
	 * @return
	 */
	QueryResult<ScientificNameGroup_old> querySpecial(QuerySpec querySpec) throws InvalidQueryException;
