...
public enum ComparisonOperator
{
	 ...
	 * or, if the field is a {@link GeoPoint} or {@link GeoShape}, that it lies within a
	 * certain area or shape. When using the IN or NOT_IN operator in a {@link Condition},
	 * the {@link Condition#getValue() value} property of the condition <b>must</b> be an
	 * array or a {@link Collection} object with zero or more elements. Example:<br>
	 * <code>
