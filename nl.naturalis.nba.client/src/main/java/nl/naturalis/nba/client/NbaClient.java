...
/**
 * Abstract base class for all client-side implementations of the NBA API. Implements shared
 * functionality specified by {@link INbaAccess} and provides HTTP request plumbing functionality
 * for subclasses.
 * 
