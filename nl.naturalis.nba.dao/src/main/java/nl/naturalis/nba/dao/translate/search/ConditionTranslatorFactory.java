...
import static nl.naturalis.nba.dao.translate.search.TranslatorUtil.getESFieldType;
...
public class ConditionTranslatorFactory {
	 ...
	 */
	public static ConditionTranslator getTranslator(SearchCondition condition, DocumentType<?> type)
			throws InvalidConditionException
	{
