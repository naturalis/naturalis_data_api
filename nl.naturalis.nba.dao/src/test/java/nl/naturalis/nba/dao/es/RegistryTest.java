...
public class RegistryTest {
	...
	public static void init()
	{
		if (SPECIMEN.getIndexInfo().getName().equals("nba")) {
			 ...
			 * Unfornately, we forgot once to often to reset nba-test.properties
			 * before running the unit tests again, wiping out the data in the
			 * nba_index. So here some bare-knuckle way to prevent this. Note
			 * that RegistryTest is the first of the unit tests within the test
			 * suite.
			 */
