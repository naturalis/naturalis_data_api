...
public class BulkIndexer<T extends IDocumentObject> {
  ...
  // TODO: decide on "request timeout"
	...
	public void index(List<T> documents, List<String> ids) throws BulkIndexException
	{
		if (documents.size() == 0) {
			/*
		...
		// TODO: find out what works best in order to prevent performance issues during a bulk transaction
