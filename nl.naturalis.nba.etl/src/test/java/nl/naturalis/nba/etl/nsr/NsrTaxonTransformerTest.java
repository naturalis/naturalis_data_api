...
public class NsrTaxonTransformerTest {
  ...
  public void testInvalidRank() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object obj = ReflectionUtil.call(nsrTaxonTransformer, "invalidRank",
          new Class[] {String.class}, new Object[] {"superfamilia"});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#isVernacularName(String nameType)}.
   * 
  ...
  public void testIsVernacularName_01() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object obj = ReflectionUtil.callStatic(NsrTaxonTransformer.class, "isVernacularName",
          new Class[] {String.class}, new Object[] {"isPreferredNameOf"});
  ...
  public void testIsVernacularName_02() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object obj = ReflectionUtil.callStatic(NsrTaxonTransformer.class, "isVernacularName",
          new Class[] {String.class}, new Object[] {"subspecies"});
  ...
  public void testGetElements() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object returned =
          CommonReflectionUtil.callMethod(null, null, nsrTaxonTransformer, "getNameElements");
  ...
  public void testAddScientificNames() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object returned = ReflectionUtil.call(nsrTaxonTransformer, "addScientificNames",
          new Class[] {Taxon.class}, new Object[] {taxon});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#add(Taxon taxon, ScientificName scientificName)}.
   * 
  ...
  public void testAdd_01() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      CommonReflectionUtil.setField(AbstractTransformer.class, nsrTaxonTransformer, "input",
          extracted);
      CommonReflectionUtil.setField(AbstractTransformer.class, nsrTaxonTransformer,
      ...
      Object returned = ReflectionUtil.call(nsrTaxonTransformer, "add",
          new Class[] {Taxon.class, ScientificName.class}, new Object[] {taxon, name});
  ...
  public void testHasTestGenus_01() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object returned = ReflectionUtil.call(nsrTaxonTransformer, "hasTestGenus",
          new Class[] {Taxon.class}, new Object[] {taxon});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#getOccurrenceStatusVerbatim(Element element)}.
   * 
  ...
  public void testGetOccurrenceStatusVerbatim() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      Object returned = ReflectionUtil.callStatic(NsrTaxonTransformer.class,
          "getOccurrenceStatusVerbatim", new Class[] {Element.class}, new Object[] {elemet});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#getScientificName(Element element)}.
   * 
   * Test to verify if the getScientificName method returns an expected {@link ScientificName}
   * object
   * 
   * @throws Exception
   * 
  ...
  public void testGetScientificName() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      returned = ReflectionUtil.call(nsrTaxonTransformer, "getScientificName",
          new Class[] {Element.class}, new Object[] {nameElems.get(1)});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#getVernacularName(Element element)}.
   * 
   * Test to verify if the getVernacularName method returns an expected {@link VernacularName}
   * object
   * 
   * @throws Exception
   * 
  ...
  public void testGetVernacularName() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      returned = ReflectionUtil.call(nsrTaxonTransformer, "getVernacularName",
          new Class[] {Element.class}, new Object[] {nameElems.get(0)});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#getReferenceDate(Element element)}.
   * 
  ...
  public void testGetReferenceDate() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      returned = ReflectionUtil.call(nsrTaxonTransformer, "getReferenceDate",
          new Class[] {Element.class}, new Object[] {nameElems.get(0)});
  ...
  /**
   * Test method for
   * {@link nl.naturalis.nba.etl.nsr.NsrTaxonTransformer#getTaxonomicStatus(Element element)}.
   * 
   * Test to verify if the getTaxonomicStatus method returns an expected {@link TaxonomicStatus}
   * object
   * 
   * @throws Exception
   * 
  ...
  public void testGetTaxonomicStatus() throws Exception {
    ...
    for (XMLRecordInfo extracted : extractor) {
      ...
      returned = ReflectionUtil.call(nsrTaxonTransformer, "getTaxonomicStatus",
          new Class[] {Element.class}, new Object[] {nameElems.get(1)});
