  ...
  //@formatter:off
	...
	public Object getSetting(
			@ApiParam(
			    ...
			    required = true, 
			    defaultValue = "index.max_result_window") 
	...
	@Path("/getPaths")
	@ApiOperation(
	    value = "Returns the full path of all fields within a document", 
	    response = String[].class, 
	    notes = "See also metadata/getFieldInfo for all allowed operators per field")
	@Produces(JSON_CONTENT_TYPE)
	...
	@Path("/getFieldInfo")
	@ApiOperation(
	    value = "Returns extended information for each field of a multimedia document", 
	    response = Map.class, 
	    notes = "Info consists of whether the fields is indexed, the ElasticSearch datatype and a list of allowed operators")
	@Produces(JSON_CONTENT_TYPE)
	...
	@ApiOperation(
	    value = "Checks if a given operator is allowed for a given field", 
	    response = Map.class, 
	    notes = "See also metadata/getFieldInfo")
	@Produces(TEXT_CONTENT_TYPE)
	public boolean isOperatorAllowed(
			@ApiParam(
			    value = "multimedia document field", 
			    required = true, 
			    defaultValue = "unitID") 
