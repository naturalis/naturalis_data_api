...
# files (es-settings.json, logback.xml, nda-export.properties)
# separate from "high-level" user-editable files. In that
# case nda.export.user.conf.dir must be changed accordingly.
# Note that it must still point to a program-agnostic top
# directory. Paths for program-specific subdirectories
# and files are generated by those programs themselves,
# relative to ${nda.export.user.conf.dir}. For example, the
# DwCA export module expects the eml files to reside in
