...
public class AbstractDaoTest {
    ...
    public void testFilterAllowedFieldMappings() throws Exception {
        ...
        fields.add(new FieldMapping("field1", 0f, "value1", "", false, false, "field"));
        fields.add(new FieldMapping("field2", 0f, "value2", "", false, false, "field"));
        fields.add(new FieldMapping("field3", 0f, "value3", "", false, false, "field"));
